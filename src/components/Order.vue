    ...
    <div class="form_order">
      ...
      <div class="buyer_info">
        ...
        <form class="buyer_name">
          ...
          <input type="text" class="buyer_name_input" placeholder="*Адрес электронной почты" required />
            ...
            <v-card flat>
              <v-card-text>
                <form class="pick_up_point">
                  ...
                  <input type="text" class="pick_up_point_input" placeholder="*Дата доставки" required />
                </form>
              </v-card-text>
            </v-card>
          </v-tab-item>
